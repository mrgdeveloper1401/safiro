...
from .models import Category, Product, ProductImage, Attribute, AttributeValue, ProductAttributeValue, ProductComment


@admin.register(Category)
class CategoryAdmin(admin.ModelAdmin):
    list_display = ('name', "parent_id", 'slug', "is_active", "created_at", "updated_at")
    search_fields = ('name',)
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', "product_name", "category_id", "stock_number", "price", "new_price", "is_active", "created_at", "updated_at")
    list_editable = ('is_active', "stock_number", "price", "new_price")
