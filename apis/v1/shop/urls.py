...
urlpatterns = (
    [
        path(
            "recommender_product/",
            RecommenderProductView.as_view(),
            name="is_amazing_product",
        ),
        path(
            "most_product_sale/",
            MostProductSaleView.as_view(),
            name="is_amazing_product",
        ),
        path(
            "most_product_discount/",
            MostProductDiscountView.as_view(),
            name="is_amazing_product",
        ),
        path(
            "detail_product/<int:pk>/<str:p_slug>/",
            DetailProductView.as_view(),
            name="detail_product",
        ),
        path(
            "detail_product/<int:pk>/<str:p_slug>/comment/",
            ProductCommentViewSet.as_view({"get": "list", "post": "create"}),
            name="product_comment",
        ),
        path(
            "detail_product/<int:pk>/<str:p_slug>/comment/<int:id>",
